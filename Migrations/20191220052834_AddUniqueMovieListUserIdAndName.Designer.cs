...
namespace movie_project.Migrations
{
    ...
    [Migration("20191220052834_AddUniqueMovieListUserIdAndName")]
    partial class AddUniqueMovieListUserIdAndName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("movie_project.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("movie_project.Models.Movie", b =>
                {
                    ...
                    b.HasKey("imdbID", "MovieListRefId");
            ...
            modelBuilder.Entity("movie_project.Models.MovieList", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserRefId", "Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("movie_project.Models.ApplicationUser", null)
                        .WithMany()
